...
class PlayScreenRandom extends StatefulWidget {
  static const id = 'play_screen_random';
  int index = 0;
  int correctNumber = 0;
  ...
  @override
  State<PlayScreenRandom> createState() => _PlayScreenRandomState();
}

class _PlayScreenRandomState extends State<PlayScreenRandom> {
